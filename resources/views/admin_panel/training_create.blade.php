                    ...
                    <div class="widget-header">                                
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>{{ isset($record_data) ? 'Update' : 'Create' }} Training Image</h4> 
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mb-4 col-6 custom-file-container">
                                    ...
                                    @if(isset($record_data) && isset($record_data->training_image))
                                        <div class="images-box-r" style="min-height: 320px;background: url({{asset('storage/training_images')}}/{{$record_data->training_image}}"></div>
                                    @endif
                                </div>
                            </div>
